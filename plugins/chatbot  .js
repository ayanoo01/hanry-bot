let handler = m => m; 
 ...
 let responses; 
 if (/^لاو بحبك|لاو عاوزه اتجوزك|بحبك|بموت فيك|نتجوز|دوفي هنتجوز امتي|لاو انت ليا|لاو بموت فيك$/i.test(m.text)) { 
 responses = [ 
 '*شكرا*  ',
   '*ونا بكرهك*',
 '*هفكر في الموضوع*',  
 ...
 }else if (/^ لاو عامل ايه|عامله ايه|عاملين ايه|كيفكم|عاملين ايه يشباب$/i.test(m.text)) { 
 responses = [ 
 ...
 }else if (/^لاو|تراو عمك| ترافلجار/i.test(m.text)) { 
 responses = [ 
 '*نعم يا قلب تراو؟* ',  
 '*ترافلجار عمك👾* ',  
 '*ي عيون لاو*',  
 ...
 responses = [ 
 '*اسمي ترافلجار يا غبي*',  
 '*مش عارف تقول لاو؟*',  
 '*بعطيك واحده تاكتو اموتك*',  
 '*انت البوت*',  
 '*اسمي لاو عايز اي؟*' 
 ]; 
