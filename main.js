...
> *˼↜ الــتــرحــيـــب↶*
*╮──────────────────⟢ـ*
*┇مــــرحــبــا بـــك مـــعـنـا*
*┇@user*
*┇بـــرجــاء قـــــراءة الــــوصــف*
*┇اســم الـجـروب @subject*

*┇الـوصــــف*
@desc
*╯──────────────────⟢ـ*
> *نتمني ان تقضي وقتا ممتعا معنا* 
`;
conn.bye = `
> *˼↜ الــمــــغادرة↶*
*╮──────────────────⟢ـ*
*┇غـــادر الـمــــجـمــوعــة*
*┇@user*
*╯──────────────────⟢ـ*
> *نـــــتـمنــي لـك وقـــت مــــمــــتع خـــــارج جـــــروبــــنا* 
`;
